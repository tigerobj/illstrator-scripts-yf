...
// 對 Date 的擴充功能，將 Date 轉換為指定格式的字串
...
Date.prototype.format = function(fmt) {
	var o = {
		"M+" : this.getMonth() + 1, // 月份（1-12）
		"d+" : this.getDate(), // 日期（1-31）
		"h+" : this.getHours(), // 小時（0-23）
		"m+" : this.getMinutes(), // 分鐘（0-59）
		"s+" : this.getSeconds(), // 秒（0-59）
		"q+" : Math.floor((this.getMonth() + 3) / 3), // 季度（1-4）
