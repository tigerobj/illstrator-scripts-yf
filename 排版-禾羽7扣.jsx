        ...
        if("尺寸字" == group.name){
          ...
          for(var j = 0;j<group.textFrames.length;j++){
            ...
            if (str.indexOf("右袖") !== -1) {
                ...
                groups.push([textFrame,item]);
                //alert("左袖");
            }else if (str.indexOf("左前") !== -1) {
                item = getPageItemByNameInLayer(doc,layer.name,"左前");
                groups.push([textFrame,item]);
                //alert("前袖");
            }else if (str.indexOf("右前") !== -1) {
                item = getPageItemByNameInLayer(doc,layer.name,"右前");
                groups.push([textFrame,item]);
                //alert("前袖");
                ...
                groups.push([textFrame,item]);
                //alert("後袖");
            }else if (str.indexOf("左門襟") !== -1) {
                item = getPageItemByNameInLayer(doc,layer.name,"左門襟");
                groups.push([textFrame,item]);
                //alert("後袖");
            }else if (str.indexOf("右門襟") !== -1) {
                item = getPageItemByNameInLayer(doc,layer.name,"右門襟");
                groups.push([textFrame,item]);
                //alert("後袖");
            }else{
                item = getPageItemByNameInLayer(doc,layer.name,"後內貼");
                groups.push([textFrame,item]);
                //alert("領");
            }
...
function isNameInKeywords(name) {
    var keywords = ["左前","右前", "後片", "左門襟", "右門襟", "左袖", "右袖", "後內貼"];
