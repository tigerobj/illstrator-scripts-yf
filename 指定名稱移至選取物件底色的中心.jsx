...
(function () {
    ...
    var backgroundCenter = getCenter(backgroundItems[0]);
    ...
    var targetCenter = getCenter(targetItem);
    var dx = backgroundCenter.x - targetCenter.x;
    var dy = backgroundCenter.y - targetCenter.y;

    targetItem.translate(dx, dy);
    doc.selection = [targetItem];

    alert("已將「" + targetName + "」移動到選取物件內「底色」的中心位置。");
})();
