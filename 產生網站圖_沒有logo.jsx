...
last = findLastFileNameByCustName(fmt,folderPath,extension,"T"+custName+"F");
...
groupLogo = getGroupByThreeLevel("服裝內容", "前面", "前片", "logo");
if(groupLogo){
  groupLogo.hidden = true; // 隱藏
}
...
removeFile(MyData["網站圖輸出位置"]+"/"+fileName+".ai");
