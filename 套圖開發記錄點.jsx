...
function showGui(allPageItems) {
    ...
    function loadKindButtons() {
        ...
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "左前袖口點"));
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "右前袖口點"));
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "左後袖口點"));
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "右後袖口點"));

        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "左袖套圖點"));
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "右袖套圖點"));
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "左袖口套圖點"));
        kindRadioButtons.push(rightPanel.add('radiobutton', undefined, "右袖口套圖點"));
