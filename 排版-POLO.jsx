        ...
        if("尺寸字" == group.name){
          ...
          for(var j = 0;j<group.textFrames.length;j++){
            ...
            if (str.indexOf("右袖") !== -1) {
                ...
                groups.push([textFrame,item]);
                //alert("後袖");
            }else if (str.indexOf("領滾條") !== -1) {
                item = getPageItemByNameInLayer(doc,layer.name,"領滾條");
                groups.push([textFrame,item]);
                //alert("後袖");
            }else if (str.indexOf("口袋") !== -1) {
                item = getPageItemByNameInLayer(doc,layer.name,"口袋");
                groups.push([textFrame,item]);
                //alert("後袖");
            }else{
...
function isNameInKeywords(name) {
    var keywords = ["前片", "後片", "左門襟", "右門襟", "左袖", "右袖", "領","領滾條","口袋"];
