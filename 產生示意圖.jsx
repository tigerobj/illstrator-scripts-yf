...
avlue = 11.5357107151372;
bvlue = 9.12349848269201;
newGroup.resize(avlue,avlue,true,true,true,true,avlue);
newItem.resize(bvlue,bvlue,true,true,true,true,bvlue);
newItem2.resize(bvlue,bvlue,true,true,true,true,bvlue);
...
frameA = getPathItemByFourLevel("底圖","背景","展示區","左區","底色");
