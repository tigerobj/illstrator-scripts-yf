...
function removeMask(layerName, groupLevel1, groupLevel2){
	group  = getGroupByTwoLevelNoAlert(layerName,groupLevel1,groupLevel2);
...
if(getGroupByLevel("裁切","左袖口")){
		removeMask2("裁切","左袖口");
}
if(getGroupByLevel("裁切","右袖口")){
		removeMask2("裁切","右袖口");
}

a = getPathItemByThreeLevel("立體版", "前面", "領", "底色");
setPathItemGrayFill(a,30);
a = getPathItemByThreeLevel("立體版", "前面", "領", "底色2");
setPathItemGrayFill(a,30);
if(getPathItemByThreeLevelNoAlert("立體版", "前面", "領", "底色3")){
	a = getPathItemByThreeLevelNoAlert("立體版", "前面", "領", "底色3");
	setPathItemGrayFill(a,30);
}
a = getPathItemByThreeLevel("立體版", "後面", "領", "底色");
setPathItemGrayFill(a,30);
