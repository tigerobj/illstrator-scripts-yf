...
//placket 門襟底色
//左門襟（通常縫在衣服左側）	leftPlacket	指縫線與鈕扣孔所在邊
//右門襟（通常縫在右側）	rightPlacket	指有鈕扣那邊

leftPlacketFillColor = getPathItemByThreeLevel("立體版","前面","門襟", "左門襟").fillColor;
rightPlacketFillColor = getPathItemByThreeLevel("立體版","前面","門襟", "右門襟").fillColor;
...
//fmt = "yyMMdd-nnn";
copyAndOpenAIFile(MyData["POLO衫裁片L"],MyData["裁片輸出"],fileName+".eps");
...
getPathItemByTwoLevel("裁切", "左門襟", "底色").fillColor = leftPlacketFillColor;
getPathItemByTwoLevel("裁切", "右門襟", "底色").fillColor = rightPlacketFillColor;
